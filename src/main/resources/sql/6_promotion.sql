INSERT INTO promotions (title, description, discount_amount, discount_percent, start_date, end_date, min_purchase, max_discount, status, branch_id)
VALUES
    ...
    ('Giảm giá Ngày Phụ Nữ Việt Nam', 'Giảm 15% cho tất cả các vé xem phim trong Ngày Phụ Nữ Việt Nam 20/10', NULL, 15.0, NOW(), DATE_ADD(NOW(), INTERVAL 14 DAY), 100000.0, 30000.0, TRUE, 3), -- Chi nhánh 3
